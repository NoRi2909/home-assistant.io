...
| `description`  | yes      | A more complete description of the to-do item than provided by the item name. | Collect all necessary documents and submit the final return. |
